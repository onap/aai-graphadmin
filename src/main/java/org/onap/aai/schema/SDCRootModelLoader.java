...
public class SDCRootModelLoader {
    ...
    private static void loadRootModels() throws AAIException {
        ...
        //This file with the root model details is referenced & taken from SDC under below repository path catalog-be/src/main/resources/config/Artifact-Generator.properties
